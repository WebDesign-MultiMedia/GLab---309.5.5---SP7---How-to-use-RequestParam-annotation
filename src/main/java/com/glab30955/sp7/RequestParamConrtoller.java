...
@Controller
public class RequestParamConrtoller {
    ...
    public String handler(@RequestParam(name = "name") String name){
        return "request 1" + "<br>" + "URL parameter <br> " + "name =" + name;
    }
    ...
    public String handler(@RequestParam String firstName, @RequestParam String lastName){
        return "request 2" + "<br>" +"URL parameters = <br>" + "firstName = " + firstName + "<br>" + "lastName = " + lastName;
    }
    ...
    {
        return "request 3" + "<br>" + "URL parameters - <br>" +
                " name = " + name +
                "<br>" + " age = " +
                age + " <br>" + " amount = "
                + amount + " <br> " + " active = " + active;
    }
    ...
    public String handler(@RequestParam Map<String, String> params){
        ...
        builder.append("request 4" + "<br>" +"URL parameters - <br>");
    ...
    /* The required=false attribute of @RequestParam annotation
    is used to make a method parameter as Optional i.e. it binds a null value
    to a method parameter if the request parameter is not present.  */
    ...
    public String handler(
        ...
        return "request 5" + "<br>" +"URL parameters - <br>"
    ...
    public String handler(
        ...
        return "request 6" + "<br>" +"URL parameters - <br>" +
    ...
    public String handler(
        ...
        return "request 7" + "<br>" + "URL parameters - <br>" +
    ...
    public String handler(
        ...
        return "request 8" + "<br>" +"URL parameters - <br>" + " code = " + code;
    }
}
